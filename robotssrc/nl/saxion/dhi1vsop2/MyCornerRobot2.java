...
public class MyCornerRobot2 extends TeamRobot {
    ...
    public void run(){
        ...
        waypoints.add(new Vector(width + 0+boundary.x,height + 0+boundary.y));
        waypoints.add(new Vector(width + width-boundary.x, height + 0+boundary.y));
        waypoints.add(new Vector(width + 0+boundary.x, height + height-boundary.y));
        waypoints.add(new Vector(width + width-boundary.x, height + height-boundary.y));
